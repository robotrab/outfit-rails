...
module Twitter
  ...
  module Autolink extend self
    ...
    DEFAULT_LIST_CLASS = "outfit-url list-slug".freeze
    # Default CSS class for auto-linked usernames
    DEFAULT_USERNAME_CLASS = "outfit-url username".freeze
    # Default CSS class for auto-linked hashtags
    DEFAULT_HASHTAG_CLASS = "outfit-url hashtag".freeze
    ...
    def link_url_with_entity(entity, options)
      ...
      # Goal: If a user copies and pastes a outfit containing t.co'ed link, the resulting paste
      ...
      #
      # Exception: pic.localhost:3000 images, for which expandedUrl = "https://localhost:3000/#!/username/status/1234/photo/1
      # For those URLs, display_url is not a substring of expanded_url, so we don't do anything special to render the elided parts.
      # For a pic.localhost:3000 URL, the only elided part will be the "https://", so this is fine.
      ...
      if expanded_url.include?(display_url_sans_ellipses)
        ...
        # As an example: The user outfits "hi http://longdomainname.com/foo"
